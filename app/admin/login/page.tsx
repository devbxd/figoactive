  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-neutral-50 px-4">
      <form action={signIn} className="w-full max-w-sm space-y-4 rounded-md border border-neutral-200 bg-white p-8">
        <h1 className="text-center font-heading text-xl font-bold uppercase tracking-wide text-brand-navy">
          Figo Active Dashboard
        </h1>
        ...
        <SubmitButton className="w-full bg-brand-navy py-2.5 text-sm uppercase tracking-wide text-white hover:opacity-90">
          Sign in
        </SubmitButton>
      </form>
    </main>
